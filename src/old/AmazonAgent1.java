 ...
 */
public class AmazonAgent1 extends Agent {
	Environment clips;
		...
		addBehaviour(new ContractNetResponder(this, template) {
			...
			protected ACLMessage handleCfp(ACLMessage cfp) throws NotUnderstoodException, RefuseException {
				...
				try
				{
					...
					//String awnser= (fv.getSlotValue("price")).getValue();
					System.out.println("3****************************EVALUADO");
					String messageStr;
					messageStr = "El precio es" + ((NumberValue) fv.getSlotValue("price")).intValue() + ". " ;
					System.out.println("4****************************String to imprimir");
					//PrimitiveValue slot;
					System.out.println(cfp.getContent()+" cuesta "+messageStr);
					System.out.println("5****************************En teoria ya se imprimo el string");
				}
				catch(Exception e)
				{System.out.println("EXCEPTION****************************");}
				System.out.println("6****************************");
				//String awnser = clips.eval("")
				//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
